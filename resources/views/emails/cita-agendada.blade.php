            ...
            @if($data['tipo_usuario'] === 'cliente')
                <div class="info-box">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value">{{ $data['empresa'] }}</span>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value">{{ $data['detalle'] ?? 'No hay detalles adicionales.' }}</span>
                    </div>
                </div>
            ...
            @elseif($data['tipo_usuario'] === 'admin')
                <div class="info-box">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value">{{ $data['persona_contacto'] }}</span>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value">{{ $data['cargo'] }}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Tipo de servicio:</span>
                        <span class="info-value">{{ $data['tipo_servicio'] }}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Número de colaboradores:</span>
                        <span class="info-value">{{ $data['num_colaboradores'] }}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Mensaje adicional:</span>
                        <span class="info-value">{{ $data['mensaje_adicional'] }}</span>
                    </div>
                </div>
